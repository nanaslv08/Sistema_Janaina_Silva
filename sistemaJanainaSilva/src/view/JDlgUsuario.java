...
public class JDlgUsuario extends javax.swing.JDialog {
    ...
    public void limparCampos(){
        JBS_jTxtCodigo.setText("");
        JBS_jTxtNome.setText("");
        JBS_jTxtApelido.setText("");
        JBS_jFmtCpf.setText("");
        JBS_jPwfSenha.setText("");
        JBS_jFmtDataNascimento.setText("");
        JBS_jCboNivel.setSelectedIndex(-1);
    ...
    public Usuario ViewBean(){
        ...
        usuario.setNome(JBS_jTxtNome.getText());
        usuario.setApelido(JBS_jTxtApelido.getText());
        usuario.setCpf(JBS_jFmtCpf.getText());
        usuario.setSenha(JBS_jPwfSenha.getText());
        SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
        try {
            usuario.setData_nasc(formato.parse(JBS_jFmtDataNascimento.getText()));
        } catch (ParseException ex) {
            //Logger.getLogger(JDlgVendas.class.getName()).log(Level.SEVERE, null, ex);
            System.out.print("por favor funciona: " + ex.getMessage());
        }
        usuario.setNivel(JBS_jCboNivel.getSelectedIndex());
    ...
    public void beanView(Usuario usuario){
        ...
        JBS_jTxtNome.setText(usuario.getNome());
        JBS_jTxtApelido.setText(usuario.getApelido());
        JBS_jFmtCpf.setText(usuario.getCpf());
        SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
//        String dataStr = formato.format();
        JBS_jFmtDataNascimento.setText(formato.format(usuario.getData_nasc()));
        JBS_jPwfSenha.setText(usuario.getSenha());
        JBS_jCboNivel.setSelectedIndex(usuario.getNivel());
